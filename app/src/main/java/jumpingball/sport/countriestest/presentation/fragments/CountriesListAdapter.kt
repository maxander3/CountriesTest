...
class CountriesListAdapter :
    ListAdapter<CountryModelDomain, CountriesListAdapter.CountryViewHolder>(object :
        DiffUtil.ItemCallback<CountryModelDomain>() {
        override fun areItemsTheSame(
            oldItem: CountryModelDomain,
            newItem: CountryModelDomain,
        ): Boolean {
